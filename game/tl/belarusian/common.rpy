...
translate belarusian strings:
    ...
    new "Вы точно хотите завершить повтор?"

    # renpy/common/00gui.rpy:378
    old "Are you sure you want to begin skipping?"
    new "Вы точно хотите начать пропуск?"

    # renpy/common/00gui.rpy:379
    old "Are you sure you want to skip to the next choice?"
    new "Вы точно хотите пропустить все до следующего выбора?"

    # renpy/common/00gui.rpy:380
    old "Are you sure you want to skip unseen dialogue to the next choice?"
    new "Вы точно хотите пропустить все непрочитанные диалоги до следующего выбора?"
    ...
    new "показывать пустое диалоговое окно"

    # renpy/common/00preferences.rpy:274
    old "text speed"
    new "скорость игрового текста"
    ...
    old "emphasize audio"
    new "усилить громкость звуковых каналов"
    ...
    new "Идет калибровка [name] ([i]/[total])"

    # renpy/common/00gamepad.rpy:58
    old "Press or move the [control!r] [kind]."
    new "Нажмите или двигайте [control!r] [kind]."
