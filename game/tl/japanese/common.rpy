...
translate japanese strings:
    ...
    new "スロットを保存する　%s: [text]"

    # renpy/common/00action_file.rpy:434
    old "Load slot %s: [text]"
    new "スロットをロードする　%s: [text]"
    ...
    new "このプログラムには、MITライセンスやGNU Lesser General Public Licenseなどの多数のライセンスに基づくフリーソフトウェアが含まれています。 全部のソースコードへのリンクを含むソフトウェアのリストは、 {a=https://www.renpy.org/l/license}here{/a}."
    ...
    new "[カウント]の画像[インデックス]がロックされています。"
    ...
    new "DirectX Webセットアップが開始されました。 タスクバーで最小化されて起動する場合があります。 プロンプトに従ってDirectXをインストールしてください。"

    # renpy/common/00gltest.rpy:272
    old "{b}Note:{/b} Microsoft's DirectX web setup program will, by default, install the Bing toolbar. If you do not want this toolbar, uncheck the appropriate box."
    new "{b}注：{/ b} MicrosoftのDirectX Webセットアッププログラムは、デフォルトでBingツールバーをインストールします。 このツールバーが必要ない場合は、適切なボックスをオフにします。"

    # renpy/common/00gltest.rpy:276
    old "When setup finishes, please click below to restart this program."
    new "セットアップが完了したら、下をクリックしてこのプログラムを再起動してください。"
    ...
    old "Back (B)"
    new "戻る（B）"
# TODO: Translation updated at 2020-02-04 11:11
