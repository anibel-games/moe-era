translate chinese_trad strings:
    ...
    new "此程序包含一系列許可證下的免費軟件，其中包括包括MIT許可證和GNU通用公共許可證。包括完整源代碼的完整軟件列表可以用這個鏈接查看：{a=https://www.renpy.org/l/license}here{/a}。"
    ...
    old "Back (B)"
    new "返回 (B)"
    # TODO: Translation updated at 2020-01-17 23:17
